...
from annotator.annotate_utils import filter_spans
...
#         sample['annotations'][current_index] = (sample[col_text][current_index], entities)
        sample.at[current_index, 'annotations'] = (sample[col_text][current_index], entities)
    ...
    def on_click(btn):
        add_annotation(df, ta.value, regex_flags)
